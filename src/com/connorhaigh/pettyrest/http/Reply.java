...
public class Reply 
{
	...
	public static final Reply METHOD_NOT_ALLOWED_405_REPLY = new Reply("405", "Method Not Allowed", "The method used for the specified resource is not allowed.");
	public static final Reply REQUEST_TOO_LARGE_413_REPLY = new Reply("413", "Request Entity Too Large", "The request is too large for this server to process.");
	...
	public static final Reply HTTP_VERSION_NOT_SUPPORTED_505_REPLY = new Reply("505", "HTTP Version Not Supported", "The HTTP version used in the request is not supported on this server.");
